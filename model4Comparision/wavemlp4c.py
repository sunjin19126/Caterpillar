...
# -----------------WaveMLP series for comparison on 4 datasets------------------------
@register_model
def WaveMLP_T_MIN(pretrained=False, **kwargs):
    transitions = [True, True, True, True]
    layers = [2, 2, 4, 2]
    mlp_ratios = [4, 4, 4, 4]
    embed_dims = [64, 128, 320, 512]
    model = WaveNet_X221(layers, embed_dims=embed_dims, patch_size=3, transitions=transitions,
                     mlp_ratios=mlp_ratios, **kwargs)
    # model.default_cfg = default_cfgs['wave_T']
    return model

@register_model
def WaveMLP_T_C10(pretrained=False, **kwargs):
    transitions = [True, True, True, True]
    layers = [2, 2, 4, 2]
    mlp_ratios = [4, 4, 4, 4]
    embed_dims = [64, 128, 320, 512]
    model = WaveNet(layers, embed_dims=embed_dims, patch_size=1, transitions=transitions,
                     mlp_ratios=mlp_ratios, **kwargs)
    # model.default_cfg = default_cfgs['wave_T']
    return model

@register_model
def WaveMLP_T_C100(pretrained=False, **kwargs):
    transitions = [True, True, True, True]
    layers = [2, 2, 4, 2]
    mlp_ratios = [4, 4, 4, 4]
    embed_dims = [64, 128, 320, 512]
...
@register_model
def WaveMLP_T_FM(pretrained=False, **kwargs):
    transitions = [True, True, True, True]
    layers = [2, 2, 4, 2]
    mlp_ratios = [4, 4, 4, 4]
    embed_dims = [64, 128, 320, 512]
    model = WaveNet_X221(layers, embed_dims=embed_dims, patch_size=1, transitions=transitions,
                     mlp_ratios=mlp_ratios, **kwargs)
    # model.default_cfg = default_cfgs['wave_T']
    return model
...
#-------------------------------------------------
@register_model
def WaveMLP_S_MIN(pretrained=False, **kwargs):
    transitions = [True, True, True, True]
    layers = [2, 3, 10, 3]
    mlp_ratios = [4, 4, 4, 4]
    embed_dims = [64, 128, 320, 512]
...
@register_model
def WaveMLP_S_C10(pretrained=False, **kwargs):
    transitions = [True, True, True, True]
    layers = [2, 3, 10, 3]
    mlp_ratios = [4, 4, 4, 4]
    embed_dims = [64, 128, 320, 512]
...
@register_model
def WaveMLP_S_C100(pretrained=False, **kwargs):
    transitions = [True, True, True, True]
    layers = [2, 3, 10, 3]
    mlp_ratios = [4, 4, 4, 4]
    embed_dims = [64, 128, 320, 512]
...
@register_model
def WaveMLP_S_FM(pretrained=False, **kwargs):
    transitions = [True, True, True, True]
    layers = [2, 3, 10, 3]
    mlp_ratios = [4, 4, 4, 4]
    embed_dims = [64, 128, 320, 512]
