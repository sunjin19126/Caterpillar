...
# ---------------------ConvMixer series for comparison on 4 datasets--------------------------------------------
@register_model
def convmixer_768_32_MIN(pretrained=False, **kwargs):
    model_args = dict(dim=768, depth=32, kernel_size=3, patch_size=12, act_layer=nn.ReLU, **kwargs)
    return _create_convmixer('convmixer_768_32', pretrained, **model_args)

@register_model
def convmixer_768_32_C10(pretrained=False, **kwargs):
    model_args = dict(dim=768, depth=32, kernel_size=3, patch_size=4, act_layer=nn.ReLU, **kwargs)
    return _create_convmixer('convmixer_768_32', pretrained, **model_args)

@register_model
def convmixer_768_32_C100(pretrained=False, **kwargs):
    model_args = dict(dim=768, depth=32, kernel_size=3, patch_size=4, act_layer=nn.ReLU, **kwargs)
    return _create_convmixer('convmixer_768_32', pretrained, **model_args)

@register_model
def convmixer_768_32_FM(pretrained=False, **kwargs):
    model_args = dict(dim=768, depth=32, kernel_size=3, patch_size=4, act_layer=nn.ReLU, **kwargs)
    return _create_convmixer('convmixer_768_32', pretrained, **model_args)