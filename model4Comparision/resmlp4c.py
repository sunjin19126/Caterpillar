...
# -----------------ResMLP series for comparison on 4 datasets------------------------
@register_model
def resmlp_S12_MIN(pretrained=False, dist=False, **kwargs):
    model = resmlp_models(
        img_size=84,
        patch_size=12, embed_dim=384, depth=12,
        Patch_layer=PatchEmbed,
        init_scale=0.1, **kwargs)
...
@register_model
def resmlp_S12_C10(pretrained=False, dist=False, **kwargs):
    model = resmlp_models(
        img_size=32,
...
@register_model
def resmlp_S12_C100(pretrained=False, dist=False, **kwargs):
    model = resmlp_models(
        img_size=32,
        patch_size=4, embed_dim=384, depth=12,
        Patch_layer=PatchEmbed,
...
@register_model
def resmlp_S12_FM(pretrained=False, dist=False, **kwargs):
    model = resmlp_models(
        img_size=28,
        patch_size=4, embed_dim=384, depth=12,
        Patch_layer=PatchEmbed,
...
# ---------------------------------------------------------------------------------
@register_model
def resmlp_S24_MIN(pretrained=False, dist=False, dino=False, **kwargs):
    model = resmlp_models(
        img_size=84,
        patch_size=12, embed_dim=384, depth=24,
        Patch_layer=PatchEmbed,
        init_scale=1e-5, **kwargs)
    # model.default_cfg = _cfg()
    if pretrained:
...
@register_model
def resmlp_S24_C10(pretrained=False, dist=False, dino=False, **kwargs):
    model = resmlp_models(
        img_size=32,
        patch_size=4, embed_dim=384, depth=24,
        Patch_layer=PatchEmbed,
        init_scale=1e-5, **kwargs)
    # model.default_cfg = _cfg()
    if pretrained:
...
@register_model
def resmlp_S24_C100(pretrained=False, dist=False, dino=False, **kwargs):
    model = resmlp_models(
        img_size=32,
        patch_size=4, embed_dim=384, depth=24,
        Patch_layer=PatchEmbed,
...
@register_model
def resmlp_S24_FM(pretrained=False, dist=False, dino=False, **kwargs):
    model = resmlp_models(
        img_size=28,
        patch_size=4, embed_dim=384, depth=24,
        Patch_layer=PatchEmbed,
