...
# ---------------------vip series for comparison on 4 datasets-------------------------------
@register_model
def vip_s4_MIN(pretrained=False, **kwargs):   # s14 for 224×224 images
    layers = [4, 3, 8, 3]
    transitions = [False, False, False, False]
    segment_dim = [7, 7, 7, 7]
    mlp_ratios = [3, 3, 3, 3]
    embed_dims = [392, 392, 392, 392]
    model = VisionPermutator(layers, embed_dims=embed_dims, patch_size=12, transitions=transitions,
        segment_dim=segment_dim, mlp_ratios=mlp_ratios, mlp_fn=WeightedPermuteMLP, **kwargs)
    # model.default_cfg = default_cfgs['ViP_S']
    return model

@register_model
def vip_s4_C10(pretrained=False, **kwargs):
    layers = [4, 3, 8, 3]
    transitions = [False, False, False, False]
    segment_dim = [8, 8, 8, 8]
    mlp_ratios = [3, 3, 3, 3]
    embed_dims = [384, 384, 384, 384]
    model = VisionPermutator(layers, embed_dims=embed_dims, patch_size=4, transitions=transitions,
        segment_dim=segment_dim, mlp_ratios=mlp_ratios, mlp_fn=WeightedPermuteMLP, **kwargs)
    # model.default_cfg = default_cfgs['ViP_S']
    return model

@register_model
def vip_s4_C100(pretrained=False, **kwargs):
    layers = [4, 3, 8, 3]
    transitions = [False, False, False, False]
    segment_dim = [8, 8, 8, 8]
    mlp_ratios = [3, 3, 3, 3]
...
@register_model
def vip_s4_FM(pretrained=False, **kwargs):
    layers = [4, 3, 8, 3]
    transitions = [False, False, False, False]
    segment_dim = [7, 7, 7, 7]
    mlp_ratios = [3, 3, 3, 3]
...
@register_model
def vip_s2_MIN(pretrained=False, **kwargs):  # s7 for 224×224 images
    layers = [4, 3, 8, 3]
    transitions = [True, False, False, False]
    segment_dim = [14, 7, 7, 7]
    mlp_ratios = [3, 3, 3, 3]
    embed_dims = [196, 392, 392, 392]
    model = VisionPermutator(layers, embed_dims=embed_dims, patch_size=6, transitions=transitions,
        segment_dim=segment_dim, mlp_ratios=mlp_ratios, mlp_fn=WeightedPermuteMLP, **kwargs)
    # model.default_cfg = default_cfgs['ViP_S']
    return model

@register_model
def vip_s2_C10(pretrained=False, **kwargs):
    layers = [4, 3, 8, 3]
    transitions = [True, False, False, False]
    segment_dim = [16, 8, 8, 8]
    mlp_ratios = [3, 3, 3, 3]
    embed_dims = [192, 384, 384, 384]
    model = VisionPermutator(layers, embed_dims=embed_dims, patch_size=2, transitions=transitions,
        segment_dim=segment_dim, mlp_ratios=mlp_ratios, mlp_fn=WeightedPermuteMLP, **kwargs)
    # model.default_cfg = default_cfgs['ViP_S']
    return model

@register_model
def vip_s2_C100(pretrained=False, **kwargs):
    layers = [4, 3, 8, 3]
    transitions = [True, False, False, False]
    segment_dim = [16, 8, 8, 8]
    mlp_ratios = [3, 3, 3, 3]
...
@register_model
def vip_s2_FM(pretrained=False, **kwargs):
    layers = [4, 3, 8, 3]
    transitions = [True, False, False, False]
    segment_dim = [14, 7, 7, 7]
    mlp_ratios = [3, 3, 3, 3]
